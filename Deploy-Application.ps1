...
Try {
	...
	[string]$appVersion = '14.1'
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '3.7.0.1'
	[string]$appScriptDate = '12/6/2019'
	[string]$appScriptAuthor = 'Steve Patterson, on his last day'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'mestrenova' -CheckDiskSpace -PersistPrompt
		...
		#Uninstall any old MestReNovas
		Remove-MSIApplications -Name "MestReNova"
		...
		Execute-MSI -Action 'Install' -Path "$dirFiles\MestReNova-14.1.0-24037_x64.msi" -Parameters 'REBOOT=ReallySuppress /QN'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'mestrenova' -CloseAppsCountdown 60
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAdNzPqxGHOuyEb
# VWFI2ndK4E+GynPN9VxtVQWLGT5hmqCCFFwwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgtfg7YlJQ
# 9Sq3KCfX3lCqN7n+tY10xEBnLVxm7wsTxnIwDQYJKoZIhvcNAQEBBQAEggEAi36x
# wxO+PqmJmKEUh8nycpGf9bawrJhQnS77ER/3qq67oDlpIaBU0qZoCH/UYNONgYJi
# qa0liu/+OtW9cRrtJcuCNZ2+1sYFs69fQst131KF4RgoLHY/PZzLWalyuCKEpZCV
# DPtOtpzAIucOkFNyGEzhqVwDhXhmKxkQjowRh93LwuBeSIPq8i3WR7+pFSWXy0PM
# wKMFiaGVJghqrPwgl31Ow8cXAxgFrclFGugMCEG++Kzl+40Ppa2UXyl4Sbu+QTml
# MIVMwQAvRDO0uoGsjv91n6XiVzsIfjHCmiuPfLMeLT3E+Sp/KzJwt2SHntBCES8w
# 5wUhgPs5LC/cmroGjaGCAqIwggKeBgkqhkiG9w0BCQYxggKPMIICiwIBATBoMFIx
...
# CSqGSIb3DQEJBTEPFw0xOTEyMDYxODAxMzZaMCMGCSqGSIb3DQEJBDEWBBRdN9Yl
# SkdJB7m0VtDXhr3oqayvvTCBnQYLKoZIhvcNAQkQAgwxgY0wgYowgYcwgYQEFGO4
...
# ggEAe2PDuxovtH4aphIV3wG9nZBGtfhsRSu9UxWFA1mrJWgJ1D6fE0BiwJNLxDU3
# Nj4eEo9sRUzULLuPH69oGSPAQz/ODMqKinVMdkqo4tXkISmZTySagT5fgt6ltAgJ
# 2vLj5qFTrbKePqqJRCZn5vMBWzmrUiyWX+cxsYT3siSvi2Xc9aKb7LlUTP8DoPoX
# nf8AG3PRPRrZgC8HUxIDjoot3Ff80hptiJIjp4H9wyCwk4n8AwxxtX7CYgj1zEoB
# dSXb7vkr9cc5yc+ny9wpjpYaWx/ixrN2bYomaziQhWTGftFdNwpgfE7Nlq7+1BT4
# lS4i+sFSWCY5+xemrtH+z4DrZQ==
